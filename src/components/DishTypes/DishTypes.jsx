    ...
    <div className="dish">
      ...
      <div className="dish__container">
        ...
        <div className="dish__item">
            ...
            />
            <label className="dish__label" htmlFor="alcohol-cocktail">
              Alcohol cocktail
            </label>
          </div>
          <div className="dish__item">
            ...
            />
            <label className="dish__label" htmlFor="biscuits-and-cookies">
          ...
          <div className="dish__item">
            <input
              ...
              value="bread"
            />
            <label className="dish__label" htmlFor="bread">
              Bread
            </label>
          </div>
          <div className="dish__item">
            <input
              ...
              value="cereals"
            />
            <label className="dish__label" htmlFor="cereals">
              Cereals
            </label>
          </div>
          <div className="dish__item">
            ...
            />
            <label className="dish__label" htmlFor="condiments-and-sauces">
          ...
          <div className="dish__item">
            <input
              ...
              value="desserts"
            />
            <label className="dish__label" htmlFor="desserts">
              Desserts
            </label>
          </div>
        </div>
        ...
        <div className="dish__item">
            <input
              ...
              value="drinks"
            />
            <label className="dish__label" htmlFor="drinks">
              Drinks
            </label>
          </div>
          <div className="dish__item">
            <input
              ...
              value="egg"
            />
            <label className="dish__label" htmlFor="egg">
              Egg
            </label>
          </div>
          <div className="dish__item">
          ...
          <div className="dish__item">
            ...
            />
            <label className="dish__label" htmlFor="pies-and-tarts">
              Pies and tarts
            </label>
          </div>
          <div className="dish__item">
          ...
          <div className="dish__item">
            <input
              ...
              value="preps"
            />
            <label className="dish__label" htmlFor="preps">
              Preps
            </label>
          </div>
        </div>
        ...
        <div className="dish__item">
          ...
          <div className="dish__item">
            <input
              ...
              value="soup"
            />
            <label className="dish__label" htmlFor="soup">
              Soup
            </label>
          </div>
          <div className="dish__item">
